...
auto CryptoDetails::toCpp(ObjcType obj) -> CppType
{
    assert(obj);
...
auto CryptoDetails::fromCpp(const CppType& cpp) -> ObjcType
{
    return [[ZKCryptoDetails alloc] initWithTxHash:(::djinni::Optional<std::experimental::optional, ::djinni::String>::fromCpp(cpp.tx_hash))
