...
auto CryptoProperties::toCpp(ObjcType obj) -> CppType
{
    assert(obj);
...
auto CryptoProperties::fromCpp(const CppType& cpp) -> ObjcType
{
    return [[ZKCryptoProperties alloc] initWithAddress:(::djinni::String::fromCpp(cpp.address))
